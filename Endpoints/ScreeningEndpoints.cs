...
public static class ScreeningEndpoints
{
    ...
    public static RouteGroupBuilder MapScreeningEndpoints(this WebApplication app)
    {
        ...
        {
            //toEntity() es un metodo definido en /screeningMapping, es un metodo de extenxion que toma la instancia creada de CreateScreeningDto y le añade este metodo nuevo.
